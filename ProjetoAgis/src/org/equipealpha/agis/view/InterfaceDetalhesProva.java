...
public class InterfaceDetalhesProva extends InterfaceBase{
    ...
    private JPanel painelEstatisticasProva;
    ...
    private RoundedPanel painelDetalhesProva;

    public InterfaceDetalhesProva() {
        addConteudo();
    }
    ...
    protected void addConteudo() {
        ...
        painelDetalhesProva = new RoundedPanel(20);
        painelDetalhesProva.setLayout(new GridBagLayout());
        painelDetalhesProva.setPreferredSize(new Dimension(650, 600));
        painelDetalhesProva.setBackground(new Color(255, 255, 255, 175));
        degradeconteudo.add(painelDetalhesProva, constraints);
        ...
        labelTitulo = new JLabel("DETALHES DA PROVA");
        ...
        painelDetalhesProva.add(painelTituloDetalhes);
        ...
        //painel das estatisticas da prova
        painelEstatisticasProva = new JPanel();
        painelEstatisticasProva.setLayout(new GridBagLayout());
        painelEstatisticasProva.setOpaque(false);
        painelEstatisticasProva.setPreferredSize(new Dimension(150, 300));
        ...
        constraints.gridy = 0;
        constraints.gridx = 0;
        painelEstatisticasProva.add(painelPorcentagemConcluidos,constraints);
        ...
        constraints.gridy = 1;
        constraints.gridx = 0;
        painelEstatisticasProva.add(painelPorcentagemPendentes,constraints);
        ...
        constraints.gridx = 1;
        constraints.gridy = 0;
        painelInfoDetalhesAtividades.add(painelEstatisticasProva,constraints);
        constraints.gridx = 0;
        constraints.gridy = 1;
        painelDetalhesProva.add(painelInfoDetalhesAtividades,constraints);
